...
const PALETTE: &[(&str, &str, &str)] = &[
    ...
    ("{{COTISATION.MONTH}}/{{COTISATION.YEAR}}", "Période", "period"),
    ("Montant Reçu : {{RECEIVED_AMOUNT}}", "Montant reçu", "amount"),
    ("Dette antérieure : {{REMAINING_DEBT}}", "Dette antérieure", "debt"),
    ("Nouveau Solde : {{NEW_BALANCE}}", "Nouveau solde (total payé année)", "balance"),
